...
// //     alert("Found item reported! (Check console for data)");
...
//       data.append("finderName", formData.finderName);
//       data.append("finderPhone", formData.finderPhone);
//       data.append("finderEmail", formData.finderEmail);
//       if (formData.image) {
